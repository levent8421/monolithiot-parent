package com.monolithiot.iot.templates.advice;
 ...
 */
@Slf4j
@ControllerAdvice(basePackages = {TemplatesConstants.Context.SAFE_CONTROLLER_PACKAGE,
        UserServiceConstants.Context.OPEN_CONTROLLER_PACKAGE})
